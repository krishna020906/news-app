...
export async function GET(
  ...
  try {
    ...
    const sections = {
      whatHappened: post.sections?.whatHappened || "",
      whyItMatters: post.sections?.whyItMatters || "",
      analysis: post.sections?.analysis || "",
      perspective: post.sections?.perspective || "",
      whoBenefits: post.sections?.whoBenefits || "",
    };
...
//         ...post,
//         id: post._id.toString(),
//         reactions: post.reactions || {}, // 🔥 important
//       }
//     };
